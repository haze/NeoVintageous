...
* Added [#787](https://github.com/NeoVintageous/NeoVintageous/issues/787): Add `vintageous_on_post_write_ex_cmd` setting to allow running ex command on post write
